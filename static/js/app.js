/**
 * =============================================================================
 * CONTROLADOR PRINCIPAL DEL FRONTEND (app.js)
 * =============================================================================
 * En sincronía con script.js: Gestiona Panel de Administración (CRUD Completo de Libros
 * y CRUD de Lectores con Apartado de Desactivados y Reactivación) y Portal del Lector.
 * =============================================================================
 */
...
let filtroEstadoLectorActual = 'activos';
